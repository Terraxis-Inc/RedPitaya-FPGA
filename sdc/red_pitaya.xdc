...
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_n_i[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_n_i[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_n_o[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_n_o[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_p_i[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_p_i[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_p_o[1]}]
